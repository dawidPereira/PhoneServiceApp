    ...
    public partial class Initwithseed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 8, new DateTime(2019, 1, 9, 9, 35, 10, 435, DateTimeKind.Utc), 5, "Klient prosi o szybki czas realizacji", 5, 1 },
                    { 7, new DateTime(2019, 1, 9, 9, 35, 10, 435, DateTimeKind.Utc), 5, "Klient serwisował telefon u konkurencji, naprawa nie odniosła pozytynego skutku. Zgłosił sie do nas z prośba o rozwiązanie problemu z niedziałajacą baterią, oraz z prosbą o personalizację etiu.", 2, 1 },
                    { 6, new DateTime(2019, 1, 9, 9, 35, 10, 435, DateTimeKind.Utc), 4, "Telefon został zalany przez klienta. Po zdarzeniu przestał działać wyświetlacz oraz głośnik", 1, 1 },
                    { 5, new DateTime(2019, 1, 9, 9, 35, 10, 435, DateTimeKind.Utc), 3, "Popsuty głośnik", 4, 1 },
                    { 4, new DateTime(2019, 1, 9, 9, 35, 10, 435, DateTimeKind.Utc), 3, "Klientowi nie działa klawiatura", 3, 1 },
                    { 3, new DateTime(2019, 1, 9, 9, 35, 10, 435, DateTimeKind.Utc), 2, "Klient nie może dodzwonić się do nikogo", 2, 1 },
                    { 2, new DateTime(2019, 1, 9, 9, 35, 10, 435, DateTimeKind.Utc), 1, "Po aktualizacji systemu, telefon znacznie spowolnił. Pojawiają się błędy graficzne, a telefon się przegrzewa", 5, 1 },
                    { 1, new DateTime(2019, 1, 9, 9, 35, 10, 435, DateTimeKind.Utc), 1, "Klient zgłasza problem z krótkim czasem pracy telefonu", 1, 1 }
                });
