...
namespace PhoneService.App.Migrations
{
    ...
    [Migration("20190109104636_Initial")]
            ...
            modelBuilder.Entity("PhoneService.Domain.Repair", b =>
                {
                    ...
                    b.HasData(
                        new { RepairId = 1, CreateDate = new DateTime(2019, 1, 9, 10, 46, 36, 145, DateTimeKind.Utc), CustomerId = 1, Description = "Klient zgłasza problem z krótkim czasem pracy telefonu", ProductId = 1, RepairStatusId = 1 },
                        new { RepairId = 2, CreateDate = new DateTime(2019, 1, 9, 10, 46, 36, 145, DateTimeKind.Utc), CustomerId = 1, Description = "Po aktualizacji systemu, telefon znacznie spowolnił. Pojawiają się błędy graficzne, a telefon się przegrzewa", ProductId = 5, RepairStatusId = 1 },
                        new { RepairId = 3, CreateDate = new DateTime(2019, 1, 9, 10, 46, 36, 145, DateTimeKind.Utc), CustomerId = 2, Description = "Klient nie może dodzwonić się do nikogo", ProductId = 2, RepairStatusId = 1 },
                        new { RepairId = 4, CreateDate = new DateTime(2019, 1, 9, 10, 46, 36, 145, DateTimeKind.Utc), CustomerId = 3, Description = "Klientowi nie działa klawiatura", ProductId = 3, RepairStatusId = 1 },
                        new { RepairId = 5, CreateDate = new DateTime(2019, 1, 9, 10, 46, 36, 145, DateTimeKind.Utc), CustomerId = 3, Description = "Popsuty głośnik", ProductId = 4, RepairStatusId = 1 },
                        new { RepairId = 6, CreateDate = new DateTime(2019, 1, 9, 10, 46, 36, 145, DateTimeKind.Utc), CustomerId = 4, Description = "Telefon został zalany przez klienta. Po zdarzeniu przestał działać wyświetlacz oraz głośnik", ProductId = 1, RepairStatusId = 1 },
                        new { RepairId = 7, CreateDate = new DateTime(2019, 1, 9, 10, 46, 36, 145, DateTimeKind.Utc), CustomerId = 5, Description = "Klient serwisował telefon u konkurencji, naprawa nie odniosła pozytynego skutku. Zgłosił sie do nas z prośba o rozwiązanie problemu z niedziałajacą baterią, oraz z prosbą o personalizację etiu.", ProductId = 2, RepairStatusId = 1 },
                        new { RepairId = 8, CreateDate = new DateTime(2019, 1, 9, 10, 46, 36, 145, DateTimeKind.Utc), CustomerId = 5, Description = "Klient prosi o szybki czas realizacji", ProductId = 5, RepairStatusId = 1 }
                    );
                });
